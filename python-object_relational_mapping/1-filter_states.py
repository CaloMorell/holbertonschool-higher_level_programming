...
if __name__ == '__main__':
    """Verifica si se proporciona el número correcto de
    argumentos de línea de comandos"""
    if len(argv) == 4:
        """Obtiene los detalles de la conexión MySQL
        desde los argumentos de la línea de comandos"""
        user = argv[1]
        password = argv[2]
        database = argv[3]

        """Establece una conexión con la
        base de datos MySQL"""
        db = MySQLdb.connect(
